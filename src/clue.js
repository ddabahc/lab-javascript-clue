...
,
 ...
 function pickMystery (){console.log (suspect,weapon,room)
}
...
console.log (pickMystery)
 ...
 function revealMystery() {console.log (pickMystery,suspectsArray.name,
  'killed Mr Boddy using', weaponsArray.name, 'in the room', roomsArray.name)
 }
